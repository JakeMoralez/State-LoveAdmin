...
export const PAGE_ACCESS_ROWS: PageAccessRow[] = [
  ...
  },
  {
    ...
    portal: 'ПС (1+)',
    sphere: '—',
    actions: 'Просмотр — ПС (1+); правка — Следящий (2+), не свой профиль. Судьи в том же реестре, сфера ЦА.',
  },
  {
    section: 'Работа',
    page: 'Академия',
  ...
  },
  {
    ...
    actions: 'Просмотр по сферам; в Гос — категории (Следящие / Главные следящие / Управляющие); создание категорийных/повторов в Гос: ЗГС+; удаление: ЗГС+',
  },
  {
    section: 'Работа',
    page: 'Чеклист',
  ...
  },
  {
    ...
    portal: 'Следящий (2+)',
    sphere: '—',
    actions: 'Лидер, зам, министр, советник, судья, конгресс — Следящий (2+); следящий — ЗГС (3+)',
  },
  {
    section: 'Форум',
    page: 'Список судей',
