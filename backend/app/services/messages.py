...
LEADER_POSITION_REQUIRED = "Укажите должность: Лидер, Заместитель, Министр или Советник."
...
PROMOTED_AT_FORBIDDEN = "Недостаточно прав для смены даты повышения."
...
ASSIGN_STAFF_NEED_ZGS = "Назначение следящего — только Следящий структуры (5) и выше."
...
UPLOAD_ACADEMY_BAD_TYPE = "Допустимы PDF, Word, Excel, PowerPoint, изображения, ZIP и TXT."

ISSUANCE_VIEW_FORBIDDEN = "Выдачи доступны ЗГС и выше."
ISSUANCE_CREATE_FORBIDDEN = "Создавать заявки на выдачу могут ЗГС и выше."
ISSUANCE_REVIEW_FORBIDDEN = "Выдавать и отклонять заявки может Следящий структуры и выше."
...
ISSUANCE_NICK_REQUIRED = "Укажите никнейм."
ISSUANCE_ROLE_REQUIRED = "Укажите должность."
ISSUANCE_REASON_REQUIRED = "Укажите, за что выдано."
ISSUANCE_PROOF_REQUIRED = "Укажите ссылку на доказательство."
ISSUANCE_PROOF_BAD = "Ссылка на доказательство должна начинаться с http."
